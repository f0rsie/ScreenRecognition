...
namespace ScreenRecognition.Desktop.ViewModel
{
    public class SignUpWindowViewModel
    {
        ...
        public async void SignUp(Window window)
        {
            ...
            {
                HandyControl.Controls.MessageBox.Show("Введены не все данные", "Ошибка регистрации", System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.Error);
                return;
            }

            if(await MailCheck() == false)
            {
                HandyControl.Controls.MessageBox.Show("Данная почта уже зарегистрирована", "Ошибка регистрации", System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.Error);
            }
            if(await LoginCheck() == false)
            {
                HandyControl.Controls.MessageBox.Show("Данный логин уже зарегистрирована", "Ошибка регистрации", System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.Error);
            ...
            HandyControl.Controls.MessageBox.Show("Аккаунт успешно зарегистрирован!", "Регистрации", System.Windows.MessageBoxButton.OK, System.Windows.MessageBoxImage.Information);
            window.Close();
        }
